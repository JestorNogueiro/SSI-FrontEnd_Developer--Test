...
const GraphDetail = ({ title, subTitle, updateTime, img }) => {
  return (
    <div className="bg-white h-64 w-80 sm:h-52 sm:w-64 md:h-64 md:w-80 md:m-3 p-2 rounded-md shadow-md transform hover:scale-105 duration-500 cursor-pointer mx-auto mt-5 ">
      <img
        src={img}
        alt="graph"
        loading="lazy"
