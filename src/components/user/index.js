    ...
    <>
      <div className=" flex flex-col h-full w-full ">
        ...
        <div
          ...
          className=" bg-white p-3 m-3 rounded-lg shadow-lg space-x-3 space-y-3"
        >
          <div
            className=" p-3 bg-blue-500 text-white h-52 mb-3 rounded-md shadow-md"
          ...
          <div className="mt-3">
            ...
            <p className="flex-1 space-x-3 space-y-3 my-3 text-sm">
              ...
              <input
                ...
                className="bg-transparent outline-none border-b-2 w-72"
              />
              <input
                type="text"
            ...
            <p>
              ...
              <input
                ...
                className="bg-transparent outline-none border-b-2 h-48 md:h-24 w-full text-sm"
              />
            </p>
